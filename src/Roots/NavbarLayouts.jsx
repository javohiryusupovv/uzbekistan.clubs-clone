  ...
  return (
    <>
      <header className="container-w">
        <nav className="nav-w flex justify-between items-center px-4 py-4 fixed z-50">
          ...
          <div>
            <article className="flex items-center gap-3 px-5 py-2 rounded-3xl cursor-pointer lang">
              ...
              <p className="text-white uppercase font-bold">English</p>
            </article>
          </div>
        </nav>
      </header>

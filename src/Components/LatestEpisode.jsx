...
export default function LatestEpisode() {
  return (
    <div className="container episode-wrapper">
      ...
      <div className="content-Episode flex gap-[40px]">
        ...
        <div className="Episode-List-Wrapper">
          <article className="mb-5">
            <h1 className="font-normal text-[22px] text-white mb-2 cursor-pointer duration-[0.2s] hover:text-[#fec775]">
              O`zbekistonlik. Students | Episode 1
            </h1>
            <h4 className="text-[17px] font-normal uppercase text-[#fec775] mb-[15px] ">
              Students
            </h4>

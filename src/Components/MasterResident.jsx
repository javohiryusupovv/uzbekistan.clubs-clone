...
function MasterResident() {
  ...
  useEffect(()=> {
    fetch('https://uzbekistans.club/api/v1/residents/')
    .then((response)=> response.json())
    .then((data)=> setResidents(data.results))
    .catch((error) => console.error('Error fetching data:', error));
  }, []);

  const getImgRendering = (index) => {
    return residents[index] ? residents[index].picture : ""
  }
      ...
      <div className="resident-master-wrapper">
        <div className="master-resident-child1">
          <div className="relative top-0 left-0 col-span-2">
            ...
            <img className="w-full h-full object-cover rounded-[10px]" src={getImgRendering(0)} alt="" />
          </div>
          <div className=" relative top-0 left-0">
            <div className="absolute left-0 top-0 resident-img cursor-pointer"></div>
            <img className="w-full h-full object-cover rounded-[10px]" src={getImgRendering(1)} alt="" />
          </div>
          <div className=" relative top-0 left-0">
            <div className="absolute left-0 top-0 resident-img cursor-pointer"></div>
            <img className="w-full h-full object-cover rounded-[10px]" src={getImgRendering(2)} alt="" />
          </div>
          <div className=" relative top-0 left-0 col-span-2">
            <div className="absolute left-0 top-0 resident-img cursor-pointer"></div>
            <img className="w-full h-full object-cover rounded-[10px]" src={getImgRendering(3)} alt="" />
          </div>
        </div>
        <div className="master-resident-child2">
          <div className="relative top-0 left-0 col-span-2">
            <div className="absolute left-0 top-0 resident-img cursor-pointer"></div>
            <img className="w-full h-full object-cover rounded-[10px]" src={getImgRendering(4)} alt="" />
          </div>
          <div className=" relative top-0 left-0 col-span-2">
            <div className="absolute left-0 top-0 resident-img cursor-pointer"></div>
            <img className="w-full h-full object-cover rounded-[10px]" src={getImgRendering(5)} alt="" />
          </div>
        </div>
        <div className="master-resident-child3">
          <div className="relative top-0 left-0 col-span-2">
            <div className="absolute left-0 top-0 resident-img cursor-pointer"></div>
            <img className="w-full h-full object-cover rounded-[10px]" src={getImgRendering(6)} alt="" />
          </div>
          <div className=" relative top-0 left-0 col-span-2">
            <div className="absolute left-0 top-0 resident-img cursor-pointer"></div>
            <img className="w-full h-full object-cover rounded-[10px]" src={getImgRendering(7)} alt="" />
          </div>
          <div className=" relative top-0 left-0 col-span-2">
            <div className="absolute left-0 top-0 resident-img cursor-pointer"></div>
            <img className="w-full h-full object-cover rounded-[10px]" src={getImgRendering(8)} alt="" />
          </div>
        </div>
